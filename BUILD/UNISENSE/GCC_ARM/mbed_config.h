...
#define MBED_CONF_APP_SPIF_CS                                             P0_5                                             // set by application
#define MBED_CONF_APP_SPIF_MISO                                           P0_14                                            // set by application
#define MBED_CONF_APP_SPIF_MOSI                                           P0_13                                            // set by application
#define MBED_CONF_APP_SPIF_SCK                                            P0_12                                            // set by application
#define MBED_CONF_APP_UPDATE_FILE                                         "mbed-os-example-blinky_application.bin"         // set by application
...
#define MBED_CONF_SPIF_DRIVER_SPI_CLK                                     P0_12                                            // set by library:spif-driver[UNISENSE]
#define MBED_CONF_SPIF_DRIVER_SPI_CS                                      P0_5                                             // set by library:spif-driver[UNISENSE]
#define MBED_CONF_SPIF_DRIVER_SPI_FREQ                                    40000000                                         // set by library:spif-driver
#define MBED_CONF_SPIF_DRIVER_SPI_MISO                                    P0_14                                            // set by library:spif-driver[UNISENSE]
#define MBED_CONF_SPIF_DRIVER_SPI_MOSI                                    P0_13                                            // set by library:spif-driver[UNISENSE]
...
#define MBED_CONF_TARGET_UART_0_FIFO_SIZE                                 32                                               // set by target:MCU_NRF52832
#define MBED_CONF_TARGET_UART_1_FIFO_SIZE                                 32                                               // set by target:MCU_NRF52832
